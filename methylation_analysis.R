...
multi.map <- read.csv('/Users/adrianharris/Desktop/kidney/illumina450k_filtering/HumanMethylation450_15017482_v.1.1_hg19_bowtie_multimap.txt', head = F, as.is = T)
